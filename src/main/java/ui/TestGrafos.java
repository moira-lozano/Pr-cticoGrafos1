...
public class TestGrafos {
    ...
    public static void main(String[] args) throws ExcepcionNroVerticesInvalido, ExcepcionAristaYaExiste, ExcepcionAristaNoExiste {
        ...
        System.out.println("1.Para un grafo no dirigido implementar el método de insertar vértice, insertar arista \n "
                + "eliminar vértice, eliminar arista,cantidad de vertices, cantidad de aristas,grado de vertice \n");
        ...
        grafo.insertarArista(1, 3);
        System.out.println(grafo);
        System.out.println("---Cantidad de vértices ---" + grafo.cantidadDeVertices());
        System.out.println("---Cantidad de aristas ---" + grafo.cantidadDeAristas());
        System.out.println("---Grado de vértice 4 ---" + grafo.gradoDeVertice(4));
     
        System.out.println("***GRAFO DIRIGIDO***");
        System.out.println(diGrafo);
        System.out.println("2.Para un grafo no dirigido implementar el método de insertar vértice, insertar arista \n "
                + "eliminar vértice, eliminar arista,cantidad de vertices, cantidad de aristas \n"
        ...
        System.out.println("3.Para un grafo dirigido implementar método o clase para encontrar si \n"
        ...
        System.out.println();
        System.out.println("5.Para un grafo dirigido implementar un método o clase que sea capas \n"
                + "de retornar los componentes de las islas que existen en dicho digrafo: ");
        diGrafo.componentesDeLasIslas();
        System.out.println();

        System.out.println("7.Para un grafo dirigido implementar un método o clase para encontrar si \n"
                + " el digrafo es débilmente conexo: " + diGrafo.esDebilmenteConexo());
        System.out.println();
        ...
        System.out.println("13.Para un grafo dirigido usando la implementación del algoritmo de \n"
        ...
        System.out.println("14.Para un grafo dirigido implementar un algoritmo que retorne cuántas \n"
