...
public class Grafo {
     ...
     */
    public String pregunta9() throws ExcepcionNroVerticesInvalido, ExcepcionAristaYaExiste {      
        String resultado = "\n";  
    ...
    /**
     * 10. Para un grafo no dirigido implementar un algoritmo para 
     * encontrar los componentes de las diferentes islas que hay en el grafo
     */
